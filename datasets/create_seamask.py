...
def define_mask(ds, time_start = datetime.datetime(2024,1,1,0), time_end = datetime.datetime(2024,1,3,20)):
    ...
    seconds_since_init = (time_start - datetime.datetime(1970,1,1,0,0,0)).total_seconds()
    ...
    mask_array = xr.Dataset(
        coords = dict(
            ...
            #time=(['time'], hours_since*60*60 + seconds_since_init, {'long_name':'time since initialization', 'units':f'seconds since 1970-01-01 00:00:00', 'standard_name':'time', 'calendar':'gregorian'})),
